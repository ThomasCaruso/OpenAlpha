...
from ...provenance import MINI_ARTIFACT_ROOT, MINI_EXPERIMENT_SHA256
...
def diagnostic_artifact_key(run_id: str) -> str:
    ...
    prefix = f"{MINI_ARTIFACT_ROOT}/runs/{run_id}"
...
def verify_existing_artifact(
    ...
    if existing.get("experiment_sha256") != MINI_EXPERIMENT_SHA256:
        raise _mismatch(
...
def publish_diagnostic_artifact(
    ...
    *,
    ...
    try:
        ...
        payload["experiment_sha256"] = MINI_EXPERIMENT_SHA256
