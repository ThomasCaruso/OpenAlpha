...
from openalpha_kronos.model.input import ColumnPresence
...
from openalpha_kronos.studies.structural_validity.common.methods import (
    MethodAResult,
    MethodBResult,
    MethodCResult,
    MethodDResult,
