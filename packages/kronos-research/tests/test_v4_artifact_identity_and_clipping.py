...
from openalpha_kronos.studies.structural_validity.mini.runner import DIAGNOSTIC_SCHEMA_VERSION
...
def test_confounded_interpretation_recommends_investigating_clipping() -> None:
    from openalpha_kronos.studies.structural_validity.common.conclusion import _recommend

    matched = {
        DiagnosticConclusion.ROUNDTRIP_INTERPRETATION_CONFOUNDED_BY_CLIPPING,
        DiagnosticConclusion.MATERIAL_CLIPPING_EXPOSURE_OBSERVED,
    }
    from openalpha_kronos.studies.structural_validity.mini.spec import THRESHOLDS
