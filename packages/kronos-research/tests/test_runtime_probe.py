...
from openalpha_kronos.studies.structural_validity.mini import runtime_probe as probe_module
...
def test_the_probe_retrieves_no_market_data() -> None:
    ...
    for forbidden in ("MarketDataProvider", "RetrievalRequest", "YahooDaily", "fetch("):
