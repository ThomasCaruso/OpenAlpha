...
from openalpha_kronos.evaluation import metrics as metrics_module
from openalpha_kronos.evaluation import validity as validity_module
from openalpha_kronos.model import normalization as normalization_module
...
from openalpha_kronos.studies.structural_validity.mini import runner as runner_module
from openalpha_kronos.studies.structural_validity.mini.invocation import WorkerInvocation
from openalpha_kronos.studies.structural_validity.mini.runner import (
    DiagnosticArtifact,
...
from openalpha_research.providers import Candle, MarketSeries, ProviderMode
...
def test_no_adapter_retains_an_implicit_last_normalization() -> None:
    ...
    from openalpha_kronos.model.contracts import ForecastModel, TokenizerCodec
...
def test_no_stored_quantity_is_called_a_likelihood() -> None:
    ...
    from openalpha_kronos.model import contracts

    fields = set(contracts.GeneratedPath.model_fields) | set(contracts.StepSampling.model_fields)
...
def test_importing_the_diagnostic_loads_no_torch() -> None:
    ...
    result = subprocess.run(
        [
            sys.executable,
            "-c",
            "import sys, openalpha_kronos.studies.structural_validity.mini; print('torch' in sys.modules)",
        ],
        capture_output=True,
        text=True,
        check=True,
