...
from openalpha_bridge.diagnostic.methods import _size_matched_controls
from openalpha_bridge.diagnostic.metrics import (
    compare_to_persistence,
    directional_accuracy,
    forecast_error,
    persistence_forecast,
)
from openalpha_bridge.diagnostic.normalization import clipping_report, fit_context_state
...
def test_random_validity_receives_no_artificial_credit_or_penalty() -> None:
    ...
    def error_of(subset):
        from openalpha_bridge.diagnostic.methods import _ensemble
...
def test_no_probability_weighted_ensemble_exists() -> None:
    from openalpha_bridge.diagnostic.methods import MethodDResult
...
def test_a_seed_mismatch_is_not_treated_as_agreement() -> None:
    from openalpha_bridge.diagnostic.runner import _compare_b_to_rollout_zero
